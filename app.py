...
for indice, linha in enumerate(sheet_alunos.iter_rows(min_row=2)): #emite apenas um certificado (min_row=2,max_row=2)
    #Cada célula contém a informação que precisamos
    ...
    data_final = linha[4].value # data de termíno
